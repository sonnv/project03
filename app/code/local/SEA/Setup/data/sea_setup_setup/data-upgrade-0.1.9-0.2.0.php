...
<a id="feature-slide-prev2" class="prev" href="javascript:void(0)">&lt;</a> <a id="feature-slide-next2" class="next" href="javascript:void(0)">&gt;</a>
<div class="peatured-products">{{block type="catalog/product_list" category_id="9" template="catalog/product/featured.phtml"}}</div>
<div class="clearfix">&nbsp;</div>
<div class="peatured-big-products">{{block type="catalog/product_list" category_id="10" template="catalog/product/featured_big.phtml"}}</div>
</div>
EOD;
    $cmsPage = array(
        'title' => 'Home page',
